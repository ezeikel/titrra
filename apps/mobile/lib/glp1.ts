...
// GLP-1 drug metadata — drives the smart defaults in onboarding (form +
// schedule pre-fill, dose rungs per drug). Education only; doses reflect common
// labelled escalation, the user confirms their own plan with their provider.
